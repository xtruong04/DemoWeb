        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="single_reson">
                    <div class="thum">
                        <div class="thum_1">
                            <img src="${pageContext.request.contextPath}/assets/img/help/1.png" alt="">
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_reson">
                    <div class="thum">
                        <div class="thum_1">
                            <img src="${pageContext.request.contextPath}/assets/img/help/2.png" alt="">
                        </div>
                    </div>
                    <div class="help_content">
                        <h4>Blood Camp</h4>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_reson">
                    <div class="thum">
                        <div class="thum_1">
                            <img src="${pageContext.request.contextPath}/assets/img/help/3.png" alt="">
                        </div>
                    </div>
                    <div class="help_content">
            ...
            <div class="col-lg-12">
                <div class="causes_active owl-carousel">
                    <div class="single_cause">
                        <div class="thumb">
                            <img src="${pageContext.request.contextPath}/assets/img/causes/1.png" alt="">
                        </div>
                    ...
                    <div class="single_cause">
                        <div class="thumb">
                            <img src="${pageContext.request.contextPath}/assets/img/causes/2.png" alt="">
                        </div>
                        <div class="causes_content">
                            <div class="custom_progress_bar">
                                <div class="progress">
                    ...
                    <div class="single_cause">
                        <div class="thumb">
                            <img src="${pageContext.request.contextPath}/assets/img/causes/3.png" alt="">
                        </div>
                        <div class="causes_content">
                            <div class="custom_progress_bar">
                                <div class="progress">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="single_volenteer">
                    <div class="volenteer_thumb">
                        <img src="${pageContext.request.contextPath}/assets/img/volenteer/1.png" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_volenteer">
                    <div class="volenteer_thumb">
                        <img src="${pageContext.request.contextPath}/assets/img/volenteer/2.png" alt="">
                    </div>
                    <div class="voolenteer_info d-flex align-items-end">
                        <div class="social_links">
                            <ul>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_volenteer">
                    <div class="volenteer_thumb">
                        <img src="${pageContext.request.contextPath}/assets/img/volenteer/3.png" alt="">
                    </div>
                    <div class="voolenteer_info d-flex align-items-end">
                        <div class="social_links">
                            <ul>
            ...
            <div class="col-lg-12">
                <div class="news_active owl-carousel">
                    <div class="single__blog d-flex align-items-center">
                        <div class="thum">
                            <img src="${pageContext.request.contextPath}/assets/img/news/1.png" alt="">
                        </div>
                        <div class="newsinfo">
                    ...
                    <div class="single__blog d-flex align-items-center">
                        <div class="thum">
                            <img src="${pageContext.request.contextPath}/assets/img/news/2.png" alt="">
                        </div>
                        <div class="newsinfo">
                            <span>July 18, 2019</span>
                            <a href="${pageContext.request.contextPath}/single-blog.html">
