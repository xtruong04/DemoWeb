<%-- 
    Document   : index
    Created on : Jun 11, 2025, 2:46:22 PM
    Author     : ADMIN
--%>
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="slider_text">
                        ...
                        <a href="${pageContext.request.contextPath}/About.html" class="boxed-btn3">Learn More
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="single_reson">
                    <div class="thum">
                        <div class="thum_1">
                            <img src="${pageContext.request.contextPath}/resources/img/help/1.png" alt="">
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_reson">
                    <div class="thum">
                        <div class="thum_1">
                            <img src="${pageContext.request.contextPath}/resources/img/help/2.png" alt="">
                        </div>
                    </div>
                    <div class="help_content">
                        <h4>Blood Camp</h4>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_reson">
                    <div class="thum">
                        <div class="thum_1">
                            <img src="${pageContext.request.contextPath}/resources/img/help/3.png" alt="">
                        </div>
                    </div>
                    <div class="help_content">
            ...
            <div class="col-lg-12">
                <div class="causes_active owl-carousel">
                    <div class="single_cause">
                        <div class="thumb">
                            <img src="${pageContext.request.contextPath}/resources/img/causes/1.png" alt="">
                        </div>
                    ...
                    <div class="single_cause">
                        <div class="thumb">
                            <img src="${pageContext.request.contextPath}/resources/img/causes/2.png" alt="">
                        </div>
                        <div class="causes_content">
                            <div class="custom_progress_bar">
                                <div class="progress">
                    ...
                    <div class="single_cause">
                        <div class="thumb">
                            <img src="${pageContext.request.contextPath}/resources/img/causes/3.png" alt="">
                        </div>
                        <div class="causes_content">
                            <div class="custom_progress_bar">
                                <div class="progress">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="single_volenteer">
                    <div class="volenteer_thumb">
                        <img src="${pageContext.request.contextPath}/resources/img/volenteer/1.png" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_volenteer">
                    <div class="volenteer_thumb">
                        <img src="${pageContext.request.contextPath}/resources/img/volenteer/2.png" alt="">
                    </div>
                    <div class="voolenteer_info d-flex align-items-end">
                        <div class="social_links">
                            <ul>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="single_volenteer">
                    <div class="volenteer_thumb">
                        <img src="${pageContext.request.contextPath}/resources/img/volenteer/3.png" alt="">
                    </div>
                    <div class="voolenteer_info d-flex align-items-end">
                        <div class="social_links">
                            <ul>
            ...
            <div class="col-lg-12">
                <div class="news_active owl-carousel">
                    <div class="single__blog d-flex align-items-center">
                        <div class="thum">
                            <img src="${pageContext.request.contextPath}/resources/img/news/1.png" alt="">
                        </div>
                        <div class="newsinfo">
                            <span>July 18, 2019</span>
                            <a href="${pageContext.request.contextPath}/single-blog.html">
                            ...
                            <p>The passage experienced a 
                                ...
                                sheets, and again.</p>
                            <a class="read_more" href="${pageContext.request.contextPath}/single-blog.html">Read More</a>
                        </div>
                    </div>
                    <div class="single__blog d-flex align-items-center">
                        <div class="thum">
                            <img src="${pageContext.request.contextPath}/resources/img/news/2.png" alt="">
                        </div>
                        <div class="newsinfo">
                            <span>July 18, 2019</span>
                            <a href="${pageContext.request.contextPath}/single-blog.html">
